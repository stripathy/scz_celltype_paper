...
# Pipeline config
_HERE = os.path.dirname(os.path.abspath(__file__))          # code/analysis/validation
_ANALYSIS = os.path.dirname(_HERE)                          # code/analysis
sys.path.insert(0, _ANALYSIS)
from pipeline_config import H5AD_DIR, SNRNASEQ_REF_PATH

# Shared constants
MODULES_DIR = os.path.join(os.path.dirname(_ANALYSIS), "modules")
