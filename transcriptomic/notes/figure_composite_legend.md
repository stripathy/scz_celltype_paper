...
dashed line, identity. Pearson r = 0.73; 72% sign-concordant.
...
| Inset i — n / ρ | n = 22 subclasses; Spearman ρ = 0.83 | as above (`cor(prop, n_de, method="spearman")`) |
...
| Panel j — concordance | 72% | `mean(sign(meta_est)==sign(xen_logFC))` |
