...
bulk <- AggregateExpression(Ruz_McLean, group.by = c("Subclass", "Donor"), return.seurat = TRUE)

df <- GetAssayData(bulk, assay = "RNA", layer = "counts")

saveRDS(df, "Files/Ruz_Mclean_pseudobulk_SCZ_subclass.rds")
...
bulk <- AggregateExpression(Ruz_MtSinai, group.by = c("Subclass", "Donor"), return.seurat = TRUE)

df <- GetAssayData(bulk, assay = "RNA", layer = "counts")

saveRDS(df, "Files/Ruz_MtSinai_pseudobulk_SCZ_subclass.rds")
...
write.csv(meta, "Files/Pseudobulk_metadata_subclass_MtSinai.csv", row.names = FALSE)
...
bulk <- AggregateExpression(OFC, group.by = c("Subclass", "Donor"), return.seurat = TRUE)

df <- GetAssayData(bulk, assay = "RNA", layer = "counts")

saveRDS(df, "Files/OFC_pseudobulk_SCZ_subclass.rds")
...
meta <- left_join(counts_OFC,meta_OFC, by = "Donor")
  ...
  write.csv(meta, "Files/Pseudobulk_metadata_subclass_OFC.csv", row.names = FALSE)
...
bulk <- AggregateExpression(Bat, group.by = c("Subclass", "Donor"), return.seurat = TRUE)

df <- GetAssayData(bulk, assay = "RNA", layer = "counts")

saveRDS(df, "Files/Bat_pseudobulk_SCZ_subclass.rds")
...
write.csv(meta, "Files/Pseudobulk_metadata_subclass_Bat.csv", row.names = FALSE)
...
bulk <- AggregateExpression(Multi, group.by = c("Subclass", "Donor"), return.seurat = TRUE)
...
meta <- left_join(counts_Multi,meta_Multi, by = "Donor")
  ...
  write.csv(meta, "Files/Pseudobulk_metadata_subclass_Multi.csv", row.names = FALSE)
...
bulk1 <- AggregateExpression(MSSM1, group.by = c("Subclass", "Donor"), return.seurat = TRUE)
bulk2 <- AggregateExpression(MSSM2, group.by = c("Subclass", "Donor"), return.seurat = TRUE)
bulk3 <- AggregateExpression(MSSM3, group.by = c("Subclass", "Donor"), return.seurat = TRUE)
bulk4 <- AggregateExpression(MSSM4, group.by = c("Subclass", "Donor"), return.seurat = TRUE)
...
saveRDS(df_combined, "Files/MSSM_pseudobulk_SCZ_subclass.rds")
...
meta <- left_join(counts_MSSM,meta_MSSM, by = "Donor")
  ...
  write.csv(meta, "Files/Pseudobulk_metadata_subclass_MSSM.csv", row.names = FALSE)
...
bulk1 <- AggregateExpression(HBCC1, group.by = c("Subclass", "Donor"), return.seurat = TRUE)
bulk2 <- AggregateExpression(HBCC2, group.by = c("Subclass", "Donor"), return.seurat = TRUE)
