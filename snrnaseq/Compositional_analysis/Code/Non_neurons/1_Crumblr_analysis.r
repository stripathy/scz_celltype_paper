...
dream_formula <- if(cohort_name=="Multiome") ~ scale(Age)+ Sex +Diagnosis else ~ scale(Age)+scale(PMI)+ Sex +Diagnosis
...
write_csv(all_results_non_neurons,"Files/crumblr_results_nonneurons.csv")
