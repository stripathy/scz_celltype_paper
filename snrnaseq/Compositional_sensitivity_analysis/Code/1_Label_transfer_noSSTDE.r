...
HBCC_meta <- bind_rows(
  read.csv("Compositional_sensitivity_analysis/Files/HBCC1_NoSST_DEgenes.csv",row.names=1,check.names=FALSE),
  read.csv("Compositional_sensitivity_analysis/Files/HBCC2_NoSST_DEgenes.csv",row.names=1,check.names=FALSE))
write.csv(HBCC_meta,"Compositional_sensitivity_analysis/Files/HBCC_NoSST_DEgenes.csv")

MSSM2_meta <- bind_rows(
  read.csv("Compositional_sensitivity_analysis/Files/MSSM2_part1_NoSST_DEgenes.csv",row.names=1,check.names=FALSE),
  read.csv("Compositional_sensitivity_analysis/Files/MSSM2_part2_NoSST_DEgenes.csv",row.names=1,check.names=FALSE),
  read.csv("Compositional_sensitivity_analysis/Files/MSSM2_part3_NoSST_DEgenes.csv",row.names=1,check.names=FALSE),
  read.csv("Compositional_sensitivity_analysis/Files/MSSM2_part4_NoSST_DEgenes.csv",row.names=1,check.names=FALSE))
write.csv(MSSM2_meta,"Compositional_sensitivity_analysis/Files/MSSM2_NoSST_DEgenes.csv")
