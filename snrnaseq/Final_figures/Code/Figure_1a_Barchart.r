...
setwd("scz_celltype_paper/snrnaseq/Final_figures")
...
all_meta_counts <- read.csv("/scratch/nendresz/scz_celltype_paper/snrnaseq/Compositional_analysis/Files/7_cohorts_metadata_names.csv",check.names=FALSE)


meta_xen <- read_csv("Data/xenium_metadata.csv",show_col_types=FALSE) %>% filter(qc_pass)
...
ggsave("Figures/Figure1a.png",tog,width=11,height=5,dpi=300,bg="white")
