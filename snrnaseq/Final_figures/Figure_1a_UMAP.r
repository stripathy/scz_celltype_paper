...
os.chdir("/scratch/nendresz/FINAL_FIGS")
...
colours=pd.read_csv("/project/rrg-shreejoy/nendresz/cluster_order_and_colors.csv")
...
meta=pd.read_csv("/scratch/nendresz/Xenium/metadata.csv")
...
plt.savefig("Figures/combined_umap_spatial.png",dpi=300,bbox_inches="tight",pad_inches=.01)
plt.savefig("Figures/combined_umap_spatial.svg",format="svg",bbox_inches="tight",pad_inches=.01)
plt.show()